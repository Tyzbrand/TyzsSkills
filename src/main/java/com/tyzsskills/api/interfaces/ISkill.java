...
public interface ISkill {
    ...
    /**
     * Gets a view of the skill prices list.
     * @return a list of prices (1st price in the list is the price from lvl 0 to lvl 1).
     */
    @NotNull @UnmodifiableView List<Integer> getPrices();
     ...
     * @return A map view where the key is the ValueSet ID
     * and the value is the corresponding {@link ValueSet} object
     */
    @NotNull @UnmodifiableView Map<String, ValueSet> getValues();
     ...
     */
    @Nullable ValueSet getValueSet(@NotNull String key);

    /**
     * Returns a vew of all modifiers affected by the skill
     * @return A {@link List} of {@link Modifier} objects
     */
    @NotNull @UnmodifiableView List<Modifier> getModifiers();
